...
export function Footer({ onAboutCallback, onSettingsCallback }: Props) {
	return <div className={style['footer']}>
		...
		<a className='text-xl ml-5 cursor-pointer' target='_blank' href='https://github.com/bquangDinh/pianola.git' rel='noopener noreferrer'>Github</a>
		<a className='text-xl ml-5 cursor-pointer' target='_blank' href='https://qdinh.me/jupiter' rel='noopener noreferrer'>Quang Dinh Bui</a>
	</div>
}